...
export default function Formation() {
  ...
  const education = [
    {
      ...
      period: "2022 - 2025",
      summary:
        "Focused on cybersecurity, digital forensics, networking, and secure software development while building strong foundations in computer science.",
    },
    {
      ...
      period: "2024 - Present",
      summary:
        "Hands-on training in modern web development using JavaScript, TypeScript, React, Node.js and full-stack application architecture.",
    },
    {
      ...
      period: "2025 - Present",
      summary:
        "Advanced training in penetration testing, vulnerability assessment, Android security testing,Active Directory,Api, adversary emulation and red team methodologies.",
    },
  ];
  ...
  const certifications = [
    ...
    {
      name: "ICCA – INE Certified Cybersecurity Analyst",
      provider: "INE Security",
      year: "2026",
    },

    {
      name: "IBM Cybersecurity Advanced Certificate",
      provider: "IBM / Coursera",
      year: "2025",
    },

    {
      name: "Practical Approach to Cyber Security (PACS)",
      provider: "TCS iON",
      year: "2025",
    },
  ...
  return (
    <section id="formation" className="py-10 max-w-4xl mx-auto px-4">
      <h2 className="text-3xl font-semibold mb-6">Education & Certifications</h2>
